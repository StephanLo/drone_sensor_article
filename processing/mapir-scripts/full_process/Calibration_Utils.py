...
def check_images_params(image_path, FileType):
    ...
    if FileType == "JPG":
        ...
        camera_model = "Survey3W_OCN" #image.tag_v2[272]  # This is not working: it doesnt see the exif data. So I am just writing manually the value for our Mapir camera
        camera_filter = camera_model[-3:]
